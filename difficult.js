...
let Wordsarray = ['BOHO','BLITHE','BLUISH','CRENULATED','CURT','DAZZLING','EXHAUSTIVE','EPONYMOUS','GALORE ','IDYLLIC  '];
...
function RandomWords(){
    ...
    if(Random >= 0 && Random < 0.1){
        Words = Wordsarray[0];
        Description.innerHTML += 'socially unconventional in a way regarded as characteristic of creative';
        console.log(Words);
    }else if(Random >= 0.1 && Random < 0.2){
        Words = Wordsarray[1];
        Description.innerHTML += "lacking due thought or consideration";
        console.log(Words);
    }else if(Random >= 0.2 && Random < 0.3){
        Words = Wordsarray[2];
        Description.innerHTML += "having a blue tinge; somewhat blue";
        console.log(Words);
    }else if(Random >= 0.3 && Random < 0.4){
        Words = Wordsarray[3];
        Description.innerHTML += "having a wavy outline ";
        console.log(Words);
    }else if(Random >= 0.4 && Random < 0.5){
        Words = Wordsarray[4];
        Description.innerHTML += "Confused";
        console.log(Words);
    }else if(Random >= 0.5 && Random < 0.6){
        Words = Wordsarray[5];
        Description.innerHTML += "bright, brilliant, or showy, colorful, and impressive ";
        console.log(Words);
    }else if(Random >= 0.6 && Random < 0.7){
        Words = Wordsarray[6];
        Description.innerHTML += "thorough / all possibilities";
        console.log(Words);
    }else if(Random >= 0.7 && Random < 0.8){
        Words = Wordsarray[7];
        Description.innerHTML += "- relating to or named after";
        console.log(Words);
    }else if(Random >= 0.8 && Random < 0.9){
        Words = Wordsarray[8];
        Description.innerHTML += "a large number of";
        console.log(Words);
    }else if(Random >= 0.9 && Random < 1){
        Words = Wordsarray[9];
        Description.innerHTML += "picturesque or pleasing";
        console.log(Words);
    }
}
